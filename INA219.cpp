...
void Ina::getVoltage (Adafruit_INA219 &ina219_A1, Adafruit_INA219 &ina219_A2, Adafruit_INA219 &ina219_A3, Adafruit_INA219 &ina219_B1, Adafruit_INA219 &ina219_B2) {
    this->shuntvoltageA1 = ina219_A1.getBusVoltage_V();
    this->shuntvoltageA2 = ina219_A2.getBusVoltage_V();
    this->shuntvoltageA3 = ina219_A3.getBusVoltage_V();
    this->shuntvoltageB1 = ina219_B1.getBusVoltage_V();
    this->shuntvoltageB2 = ina219_B2.getBusVoltage_V();
