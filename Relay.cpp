...
Relay::Relay(uint8_t r1, uint8_t r2, uint8_t r3, uint8_t r4, uint8_t rmeasured) : _relay1(r1), _relay2(r2), _relay3(r3), _relay4(r4), _relaymeasured(rmeasured) {
...
void Relay::turnON(int relayNum, RelayData consumers[RELAYS_NUMBER]) {
    ...
    case 5:
        digitalWrite(_relaymeasured, LOW);
        break;
    }
}
...
void Relay::turnOFF(int relayNum, RelayData consumers[RELAYS_NUMBER]) {
    ...
    case 4:
        ...
        break;
    case 5:
        digitalWrite(_relaymeasured, HIGH);
        break;
    }
}
